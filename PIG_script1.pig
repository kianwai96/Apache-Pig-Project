...
pvs1_gps_mpu_left = LOAD '/user/hdfs/dataset_gps_mpu_left.csv' USING PigStorage(',') AS (timestamp:long, acc_x_dashboard: double, acc_y_dashboard: double, acc_z_dashboard:double, acc_x_above_suspension: double, acc_y_above_suspension: double,	acc_z_above_suspension: double,	acc_x_below_suspension: double,	acc_y_below_suspension: double,	acc_z_below_suspension: double,	gyro_x_dashboard: double, gyro_y_dashboard: double, gyro_z_dashboard: double, gyro_x_above_suspension: double, gyro_y_above_suspension: double,	gyro_z_above_suspension: double, gyro_x_below_suspension: double, gyro_y_below_suspension: double, gyro_z_below_suspension: double, mag_x_dashboard: double, mag_y_dashboard: double, mag_z_dashboard: double, mag_x_above_suspension: double,	mag_y_above_suspension: double,	mag_z_above_suspension: double,	temp_dashboard: double,	temp_above_suspension: double, temp_below_suspension: double, timestamp_gps: double, latitude: double, longitude: double, speed: double);
...
left_final_pvs1 = UNION aggregated_paved_road, aggregated_unpaved_road, aggregated_dirt_road, aggregated_cobblestone_road, aggregated_asphalt_road,
...
STORE left_final_pvs1 INTO '/user/pig/output' USING PigStorage(',');
